...
This list is a checklist to help you try the deeper use cases and increase the depth of your AI usage. Tick each item's checkbox as you adopt the practice, and use the Self-check prompts to decide whether you're really doing it.
...
- [ ] AI tool use is compliant with company policy and security guidelines
...
- [ ] Token usage and limits are understood
...
- [ ] AI is used for codebase navigation and understanding
...
- [ ] Planning mode is used before coding starts
...
- [ ] Agent mode is used for code generation, not autocomplete or pure chat
...
- [ ] AI is used for managing branches, PR summaries, and explanation of changes
...
- [ ] Both IDE/desktop and CLI AI agents have been tried
...
- [ ] AI is used for refactoring and cleaning up existing code
...
- [ ] AI is used for self code review before submitting PRs
...
- [ ] AI is used in an agentic loop that includes build, static analysis, and automated tests
...
- [ ] AI is used to create and maintain technical documentation
...
- [ ] Task brief or spec files are created before the implementation of larger features
...
- [ ] AI is used to generate detailed requirements and explain happy and failure paths
...
- [ ] AI is used for architecture and design-level decisions for the feature
...
- [ ] AI is used to create ADRs and update architecture documentation
...
- [ ] Agent instructions are committed in the repo
...
- [ ] Repeated tasks and reusable commands are documented in the form of custom Skills
...
- [ ] Sub-agents are used to delegate parallel or scoped subtasks
...
- [ ] AI is used to generate or improve unit tests
...
- [ ] AI is used for integration tests, E2E tests, fixtures, and realistic test data
...
- [ ] Browser/device automation is used for testing and UI interaction
...
- [ ] AI is used to debug failing tests and flaky behavior
...
- [ ] MCP servers are connected and used
...
- [ ] AI is used to inspect logs, API responses, and data snapshots safely
...
- [ ] AI is used to explore databases, model data, query, and generate migrations
...
- [ ] Voice input is used to work with AI coding tools
...
- [ ] Permissions are expanded to enable more autonomous agent work
...
- [ ] Git worktrees are used to run multiple features or branches in parallel
...
- [ ] Parallel service instances run on localhost for parallel integration and E2E tests
...
- [ ] Token usage is actively optimized with compression and filtering tools
...
- [ ] AI is used to manage dependency upgrades and security patches
...
- [ ] AI is used for incident response and on-call workflows
