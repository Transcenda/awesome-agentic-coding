...
### 5. Planning mode is used before coding starts
...
### 7. AI is used for managing branches, generating the PR summaries and explanation of changes
...
### 8. Both IDE/desktop and CLI AI agents have been tried
...
### 9. AI is used for refactoring and cleaning up existing code
...
### 10. AI is used for self code review before submitting PRs
...
### 11. AI is used in an agentic loop that includes build, static analysis, and automated tests
...
### 12. AI is used to create and maintain technical documentation
...
### 14. AI is used to generate detailed requirements for a comprehensive UX and explain various happy and failure paths
...
### 15. AI is used for architecture and design-level decisions for the feature
...
### 16. AI is used to create ADRs and update architecture documentation for the whole codebase
...
### 17. Agent instructions are committed in the repo
...
### 20. Sub-agents are used to delegate parallel or scoped subtasks
...
### 21. AI is used to generate or improve unit tests
...
### 23. Browser/device automation is used for testing and UI interaction
...
### 25. MCP servers are connected and used
...
### 29. Permissions are expanded to enable more autonomous agent work
...
### 30. Git worktrees are used to run multiple features or branches in parallel on one machine
...
### 31. Parallel service instances run on localhost for parallel integration and E2E tests
...
### 32. Token usage is actively optimized with compression and filtering tools
